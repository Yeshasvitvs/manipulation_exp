...
% % STD = 0.0001; %Noise Standard Deviation
% % 
% % 
...
% % 
% % % % figure;
% % % % plot(t,theta); title('Revolute Joint Variable');  xlabel('sec'); ylabel('degrees');
% % % % print('theta_change','-dpng','-r300');
% % 
% % %%Joint Axes
% % figure;
...
% % 
% % figure;
% % subplot(2,1,1); plot(t,dh_A_P); title('Prismatic - Rate of Change of Momentum');  xlabel('sec'); legend('d_x','d_y','d_z','d_{ox}','d_{oy}','d_{oz}')
% % subplot(2,1,2); plot(t,dh_A_R); title('Revolute - Rate of Change of Momentum');  xlabel('sec'); legend('d_x','d_y','d_z','d_{ox}','d_{oy}','d_{oz}')
% % 
% % %%Wrench - Local Frame
% % % % figure;
...
% % % % %%Wrench - Local Frame
% % % % figure;
% % % % subplot(3,1,1); plot(t,G_A_1); title('Body 1 Gravitational Forces');  xlabel('sec'); legend('e_{ox}','e_{oy}','e_{oz}','e_x','e_y','e_z');
% % % % subplot(3,1,2); plot(t,G_A_2); title('Body 2 Gravitational Forces');  xlabel('sec'); legend('e_{ox}','e_{oy}','e_{oz}','e_x','e_y','e_z');
% % % % subplot(3,1,3); plot(t,G); title('Total Gravitational Forces');  xlabel('sec'); legend('e_{ox}','e_{oy}','e_{oz}','e_x','e_y','e_z');
% % 
